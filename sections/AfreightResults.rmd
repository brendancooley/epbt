...
source("../estimation/05_freight.R")

```

### Maritime Freight Costs

```{r seaModel, echo=FALSE, warning=FALSE, message=FALSE, results="asis", cache=TRUE}
...
```{r landModel, echo=FALSE, warning=FALSE, message=FALSE, results="asis", cache=TRUE}
...
```{r airModel, echo=FALSE, warning=FALSE, message=FALSE, results="asis", cache=TRUE}
