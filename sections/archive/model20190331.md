...
There is a continuum of tradable varieties, indexed by $\omega \in [0, 1]$. There is a set of $\mathcal{K}$ tradable good categories indexed $k \in \left\{ 0, ..., K - 1 \right\}$. Let
$$
