...
```{r tcosts, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "Distribution of freight costs, tariff barriers, and structural policy barriers to trade ($\\tau_{ij}$). Dashed lines show mean of each distribution. \\label{fig:tcosts}", fig.height=4.5, fig.width=6.5, dpi=300, fig.pos="t"}
...
![Policy barrier estimates, magnitudes and uncertainty intervals. Each panel displays the estimated policy barriers applied by an importing country on products from every in-sample source country. An interactive version of this plot is available at \protect\url{https://brendancooley.shinyapps.io/epbt}. \label{fig:tau_ci}](figure/tauq_ci.pdf){ width=7.5in height=9.5in}
