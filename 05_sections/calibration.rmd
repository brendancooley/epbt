...
```{r P, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "Price index estimates and tradable expenditure shares \\label{fig:P}", fig.height=5, fig.width=6.5, dpi=300, fig.pos="t"}
