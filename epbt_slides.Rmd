...
```{r hm, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5.5, dpi=300}
...
*International trading system neither free nor fair -- and developing world bears brunt of inequality*
...
**Definition:** An *international equilibrium* is a vector of wages $\boldsymbol{w}$ such that Equations \ref{eq:tIncome}, \ref{eq:lambda}, and \ref{eq:marketClearing} hold for all $i \in \left\{1, ..., N \right\}$.
...
```{r prices, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5.5, dpi=300}
...
```{r freightCV, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5.5, dpi=300}
...
```{r hmEUPlot, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5.5, dpi=300}
