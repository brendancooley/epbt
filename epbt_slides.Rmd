...
output:
  revealjs::revealjs_presentation:
    template: "/Users/bcooley/Dropbox (Princeton)/8_Templates/slides/cooley-reveal.html"
    css: "/Users/bcooley/Dropbox (Princeton)/8_Templates/slides/cooley-reveal.css"
...
gdp <- read_csv(paste0("estimation/", cleandir, "gdp.csv"))
pop <- read_csv(paste0("estimation/", cleandir, "pop.csv"))
tar <- read_csv(paste0("estimation/", cleandir, "tarY.csv"))

correlates <- read_csv(paste0("estimation/", resultsdir, "/correlates.csv"))

delta <- read_csv(paste0("estimation/", cleandir, "delta.csv")) %>% filter(year==Y)
tau <- read_csv(paste0("estimation/", resultsdir, "tauY.csv"))
tar <- read_csv(paste0("estimation/", cleandir, "tarY.csv"))

shares <- read_csv(paste0("estimation/", cleandir, "shares.csv"))

tauHMY <- read_csv(paste0("estimation/", resultsdir, "tauHMY.csv"))
tauHMYEUD <- read_csv(paste0("estimation/", resultsdirEU, "tauY.csv"))

P <- read_csv(paste0("estimation/", cleandir, "priceIndex.csv"))

freight <- read_csv(paste0("estimation/", cleandir, "freight.csv"))
